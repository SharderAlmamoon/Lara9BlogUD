      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            ...
            <li class="sub-item"><a href="{{route('create.category')}}" class="sub-link">Add Category</a></li>
          </ul>
        </li>
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('manage.author')}}" class="sub-link">Manage Author</a></li>
            <!-- <li class="sub-item"><a href="{{route('create.category')}}" class="sub-link">Add Category</a></li> -->
          </ul>
        </li>
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('manage.post')}}" class="sub-link">Manage Post</a></li>
            <li class="sub-item"><a href="{{route('post.create')}}" class="sub-link">Add Post</a></li>
          </ul>
        </li>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('footer.manage')}}" class="sub-link">Manage Footer</a></li>
