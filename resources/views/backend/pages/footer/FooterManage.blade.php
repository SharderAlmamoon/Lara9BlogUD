                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('about.delete',$about->id)}}" id="delete" class="btn-sm btn-danger btn"><i class="fa fa-trash"></i></a>
                                    <a href="{{route('about.multiimage',$about->id)}}" class="btn-sm btn-dark btn"><i class="fa fa-plus"></i></a>
                                </td>
                            </tr>
                            @php $serial++ @endphp
                            @endforeach
