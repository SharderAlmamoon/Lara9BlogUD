                    ...
                    <div class="ml-2 mt-3">
                       ...
                       <form action="{{route('update.slider',$slider->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slider_title" value="{{old('slider_title',$slider->slider_title)}}" name="slider_title">
                          </div>
                        <!-- slider_shortdes -->
                          <div class="form-group">
                            <label for="slider_shortdes"> <b>Slider Shortdes</b></label>
                            <input type="text" class="form-control" id="slider_shortdes" value="{{old('slider_shortdes',$slider->slider_shortdes)}}" name="slider_shortdes">
                          </div>

                        <!-- slider_url -->
                          <div class="form-group">
                            <label for="slider_url"> <b>Slider Url :</b></label>
                            <input type="text" class="form-control" id="slider_url" value="{{old('slider_url',$slider->slider_url)}}" name="slider_url">
                          </div>
                        ...
                        <!-- slider_image -->
                          ...
                          <div class="text-center mt-2">
                            <img id="showimage" src="{{asset('backend/sliderImage/'.$slider->slider_image)}}" class=" rounded avatar-lg" width="100" alt="ADMIN IMAGE" >
                        </div>

                        <button class="btn btn-sm btn-primary" type="submit">Slider Updated</button>
