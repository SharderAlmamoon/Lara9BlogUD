                    ...
                    <div class="ml-2 mt-3">
                       ...
                       <form action="{{route('insert.about')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="short_title" placeholder="Enter Short Title" value="{{old('short_title')}}" name="short_title">
                          </div>

                        <!-- short_description -->
                          <div class="form-group">
                            <label for="short_description"> <b>short_description</b></label>
                            <input type="text" class="form-control" id="short_description" value="{{old('short_description')}}" name="short_description" placeholder="Enter Short Description">
                          </div>

                        <!-- long_description -->
                          <div class="form-group">
                            <label for="#"> <b>long_description :</b></label>
                            <textarea name="long_description" id="summernote" class="form-control" cols="5" rows="3" placeholder="Enter Long Description">{{old('long_description')}}</textarea>
                          </div>
