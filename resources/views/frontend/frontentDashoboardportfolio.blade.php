...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <main>
            <!-- breadcrumb-area -->
            @foreach($portfoliod as $portfolios)
            @if($portfolios->id >= 1)
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{$portfolios->portfolio_title}}</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="services__details__thumb">
                                <img src="{{asset('backend/portfolioImage/'.$portfolios->portfolio_image)}}" alt="">
                            </div>
                            <div class="services__details__content">
                                {!! $portfolios->portfolio_longdescription !!}
                            </div>
                        </div>
                        <div class="col-lg-4">
