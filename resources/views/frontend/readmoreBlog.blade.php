                            ...
                            <aside class="blog__sidebar">
                                    ...
                                    <ul class="rc__post">
                                        ...
                                        <li class="rc__post__item">
                                            ...
                                            <div class="rc__post__content">
                                                <h5 class="title"><a href="blog-details.html">{{Str::limit($recentBlog->post_title,25)}}</a></h5>
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="sidebar__cat">
                                        ...
                                        <li class="sidebar__cat__item"><a href="blog.html">{{ $categories->post_category_name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <div class="widget">
